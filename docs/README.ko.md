...
| 06 | [preRegisteredHandler 참조 안정성](./06-preregistered-handler-reference-stability.ko.md) | `preRegisteredHandler`가 stable reference를 유지해야 하는 이유 (useCurrentOverlayRef 패턴). |
